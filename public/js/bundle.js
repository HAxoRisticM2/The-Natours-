...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibXVydGF6YS15YXNlZW4zMjEiLCJhIjoiY21iYzJhczY1MDk1cTJpc2JjZGtpeTFseCJ9.jWDi_hq0QRYO8TT5p2fcXw';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/murtaza-yaseen321/cmbdptg47003301qw7miyaukn',
    // map style
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<h4>Day ".concat(loc.day, ": ").concat(loc.description, "</h4>")).addTo(map);
